...
class RunAfterCompile {
  apply(compiler) {
    compiler.hooks.done.tap("Update functions.php", function () {
      ...
      fse.readFile("../../app/setup.php", "utf8", function (err, data) {
        if (err) {
          console.log(err)
        }
        ...
        fse.writeFile("../../app/setup.php", result, "utf8", function (err) {
...
if (currentTask == "devFast") {
  ...
  config.devServer = {
    before: function (app, server) {
      ...
      server._watch(["../../**/*.php", "!../../app/setup.php"])
    },
    // public: "http://localhost:3008",
    public: "http://localhost:3008/",
    ...
    contentBasePublicPath: "http://localhost:3008/",
    hot: true,
    port: 3008,
    headers: {
